...
/// OLD version of FX before it was made abstract, to keep compatibility with existing projects as we kept the .meta
/// of the original FX associated to this file. Please gradually shift OLD_FX components to new FXWithAnimation or
/// FXWithParticleSystem components, depending on your needs. In code, if you need to keep compatibility with both
/// types of FX, you can just replace OLD_FX type with the new abstract class FX type.
...
[Obsolete("Use FXWithAnimation or FXWithParticleSystem")]
public class OLD_FX : StandardMasterPooledObject
{
    [Header("Parameters")]
